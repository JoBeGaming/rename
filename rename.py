...
class rename():
  ...
  def _error(self) -> Never:
    raise NameError(f"Name '{self._name}' is not defined. Maybe you meant '{self.func}'?")
  ...
  def __call__(self, *args, **kwargs) -> Any:
    if not self._called:
      ...
      # `renames._error`, which throws a `TypeError`
      # "Name'{self._name}' is not defined. Maybe you meant '{self.func}'?" 
      return self._error
